    ...
    <div style="text-align: center">
        ...
        <table>
            ...
            <tr>
                ...
                <td align="center" class="style2">
                    <asp:TextBox ID="txtCapacidadCarga" runat="server" CssClass="Estilo" Width="150px"></asp:TextBox>
                </td>
                <td align="center" class="style4">
                    <asp:RegularExpressionValidator ID="regExCapacidad" runat="server" 
                        ControlToValidate="txtCapacidadCarga" ErrorMessage="Ingrese solo números." 
                        ValidationExpression="^[0-9]*"></asp:RegularExpressionValidator>
                </td>
                <td style="width: 100px" align="center">
                </td>
            ...
            <tr>
                ...
                <td align="center" class="style2">
                    <asp:TextBox ID="txtTipoUtilitario" runat="server" CssClass="Estilo" Width="150px"></asp:TextBox>
                </td>
                <td align="center" class="style4">
                    &nbsp;</td>
                <td style="width: 100px" align="center">
